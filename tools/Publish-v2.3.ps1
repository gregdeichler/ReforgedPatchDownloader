...
$releaseName = if ($SelfContained) { "ProjectReforgedPatchDownloader-v2.3-selfcontained" } else { "ProjectReforgedPatchDownloader-v2.3" }
...
if (Test-Path -LiteralPath (Join-Path $projectRoot "RELEASE-README.txt")) {
